...
public class ListStaff extends ArrayList<Staff> {
    ...
    public void addLecture() {
        ...
        lec.Input();
        this.add(lec);
        savaToFile("C:\\tạm\\EiuStaff.eiu.txt");
    }
    ...
    public void salaryByType(String fName) {
        ...
        try {
            ...
            double totalSpe = 0;
            for (Staff st : this) {
                if (st.getClass().toString().compareTo("class com.mycompany.assignment2.Lecturers") == 0) {
                    totalLec += st.salary;
                } else if (st.getClass().toString().compareTo("class com.mycompany.assignment2.TeachingAssistant")==0) {
                    totalAssi += st.salary;
                } else if ((st.getClass().toString().compareTo("class com.mycompany.assignment2.Researchers")==0)) {
                    totalRe += st.salary;
                } else if ((st.getClass().toString().compareTo("class com.mycompany.assignment2.Specialists")==0)){
                    totalSpe += st.salary;
                }
            }
